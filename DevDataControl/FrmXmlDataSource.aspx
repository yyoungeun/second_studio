...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:DataList ID="ctlMyInterest" runat="server" DataSourceID="xmlMyInterest">
                <ItemTemplate>
                    <em><%# XPath("title") %></em>: <%# XPath("description") %>
                </ItemTemplate>
            </asp:DataList>
            <asp:XmlDataSource ID="xmlMyInterest" runat="server" DataFile="~/FrmXmlDatasource.xml"></asp:XmlDataSource>
        </div>
    </form>
</body>
</html>
