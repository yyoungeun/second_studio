    ...
    public class BoardLibrary
    {
        ...
        public static string FuncStep(object objStep)
        {
            ...
            else
            {
                ...
                {
                    strTemp = String.Format("<img src=\"{0}\" height=\"{1}\" width=\"{2}\">", "/images/dnn/blank.gif", "0", (intStep * 15));
                }
        ...
        public static string FuncFileDownSingle(int id, string strFileName, string strFileSize)
        {
            ...
            {
                return "<a href=\"/DotNetNote/BoardDown.aspx?Id=" + id.ToString() + "\">" + DownloadType(strFileName, strFileName + "(" + ConvertToFileSize(Convert.ToInt32(strFileSize)) + ")") + "</a>";
            }
            else
            {
                return "-";
        ...
        /// <param name="= altString">alt메시지로 넣을 문자열</param>
        /// 
        public static string DownloadType(string strFileName, string altString)
        {
            ...
            switch (strFileExt)
            {
                ...
                case "htm":
                    r = "<img src = '/images/ext/ext_grm.gif' border='0' alt='"+altString+"'>"; break;
                case "html":
                ...
                case "jpeg":
                    r = "<img src = '/images/ext/ext_jpeg.gif' border='0' alt='" + altString + "'>"; break;
                case "js":
