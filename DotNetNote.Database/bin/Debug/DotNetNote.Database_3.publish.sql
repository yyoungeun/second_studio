...
GO
PRINT N'[dbo].[Memos]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';
...
As
	Declare @strSql NVarChar(255)  --변수 선언
	Set @strSql = '
					Select * 
					From Users
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd5033c62-c623-4f57-8194-19207526c166')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d5033c62-c623-4f57-8194-19207526c166')
